...
describe('global operational time header guardrails', () => {
  ...
  it('keeps four equally weighted, readable clocks in the integrated top bar and places an inset alert below', () => {
    ...
    expect(header).not.toContain('operational-clock--default')
    expect(css).not.toContain('.operational-clock--default')
    expect(themeCss).not.toContain('.operational-clock--default')
