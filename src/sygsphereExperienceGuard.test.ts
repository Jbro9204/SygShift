...
describe('SygSphere experience boundaries', () => {
  ...
  it('routes every supported attachment through one bounded, recoverable private quarantine path', () => {
    ...
    expect(data).not.toContain('sphereDirectUploadMaxBytes')
    expect(data).not.toContain('sphereDirectUpload(')
    expect(data).toContain("fetch('/api/v1/sygsphere/uploads'")
