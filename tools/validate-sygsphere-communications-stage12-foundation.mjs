...
if (manifest.contractVersion !== '1.0.0-draft.6' || manifest.lifecycle !== 'operational-shared-runtime') {
  failures.push('The shared contract manifest does not identify the operational shared runtime.')
}
