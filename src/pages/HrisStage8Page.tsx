...
function Pagination({ itemCount, offset, pageSize, onOffset, onPageSize }: {
  itemCount: number
  offset: number
  pageSize: HrStage8PageSize
  onOffset: (value: number) => void
  onPageSize: (value: HrStage8PageSize) => void
}) {
  return (
    <div className="compact-pagination panel">
      ...
      <label className="compact-page-size"><span>Show</span><select onChange={(event) => onPageSize(Number(event.target.value) as HrStage8PageSize)} value={pageSize}><option value="5">5</option><option value="10">10</option><option value="20">20</option></select></label>
