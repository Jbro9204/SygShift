...
const review: TimekeepingReview = {
  ...
  payrollRules: {
    ...
    payrollCalculationPolicyVersion: 'payroll-batch-v1',
  ...
  rows: [{
    ...
    paidMinutes: 630,
    payrollNotes: [],
    payrollOccurrenceKey: 'unscheduled:73000000-0000-4000-8000-000000000001:2026-07-30',
    payrollAssignmentSource: 'unscheduled_actual_punch',
    payrollAssignmentStatus: 'derived',
    payrollAssignmentExplanation: 'Unscheduled work follows the actual clock-in.',
