...
begin
  ...
  /*
    Serialize punch decisions per employee. The client disables buttons, and
    idempotency protects retries, but this lock prevents two fast independent
    requests from both reading the same previous punch and creating an invalid
    double clock-in / double break / double clock-out sequence.
  */
  ...
  if found then
    ...
    return jsonb_build_object(
      ...
      'effectiveAt', existing_event.recorded_at,
